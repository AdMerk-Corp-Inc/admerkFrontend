    ...
    <section className="my-tickets-div" style={{ backgroundColor: '#0061df08' }}>
      <div className="container-md py-5 h-100">
        <div className="card rounded-3">
          ...
          <div className='px-4 pt-4 d-flex align-items-center justify-content-end status-filter-div mb-4'>
          ...
          <div className='px-4 pb-4 table-div table-responsive'>
            <CreateTicket
              show={modalShow}
                ...
                {allTickets?.length > 0 ? allTickets.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td><a href='javascript:void(0);' onClick={() => {
                      setId(item?.id)
                      setModalShow(true)
                    }}><i class="fa-solid fa-eye text-primary pt-2"></i></a></td>
                  </tr>
                )) : <tr>
                  <td colSpan={8}>
