            ...
            <div className="card rounded-3">
               <div className="card-body p-4 p-lg-5">
                  <div className="d-lg-none d-flex justify-content-end mb-4">
                     {/* {!id && (
                        <a
                           className="custom-sm-btn btn mt-0"
                           href="/edit-profile"
                        >
                           <i
                              class="fa fa-pencil me-1 text-white"
                              aria-hidden="true"
                           ></i>{" "}
                           Edit
                        </a>
                     )} */}
                     {id && user?.whatsapp_number && (
                        <a
                           className="custom-sm-btn btn mt-0"
                           href={`https://wa.me/${user?.whatsapp_number}`}
                        >
                           <i
                              class="fa-brands fa-whatsapp me-1 text-white"
                              aria-hidden="true"
                           ></i>{" "}
                           Contact On Whatsapp
                        </a>
                     ...
                     <div className="d-sm-flex align-items-center">
                        {user.role === 6 ? (
                           user?.logo ? (
                              ...
                              <img
                                 className="img-size rounded"
                                 src="/assets/images/company-placeholder.jpeg"
                              />
                           )
                        ) : user?.profile_photo ? (
                           <img
                              className="img-size rounded"
                              src={`${node_url}${user?.profile_photo}`}
                              alt="Sample photo"
                           />
                        ) : (
                           <img
                        ...
                        <div className="ms-0 ms-sm-4 ms-md-5 mt-4 mt-sm-0">
                           <div className="d-flex">
                              <h3 className="styling_name text-capitalize">
                                 {user?.name}
                              </h3>

                              <div className="d-flex align-self-center ml_countryname">
                                 <i className="fa-sharp fa-solid fa-location-dot"></i>
                                 <span className="styling_country ps-2">
                                    {user?.country_name} {user?.state_name}{" "}
                                    {user?.city_name}{" "}
                                    {user?.zip_code &&
                           ...
                           {!id && (
                              <div className=" py-2">
                                 ...
                                 <span className="styling_country font_color">
                                    {user?.email}
                                 </span>
                              </div>
                           )}
                     ...
                     <>
                        <div className="row mt-4 mt-sm-5">
                           <div className="col-md-4 col-sm-6">
                              <h5 className=" heading">Since</h5>
                              <span className="text-secondary ">
                                 {user?.since}
                              </span>
                           </div>
                           <div className="col-md-4 col-sm-6">
                              <h5 className=" heading">Office Locationn</h5>
                              <span className="text-secondary ">
                                 {user?.office_location}
                              </span>
                           </div>
                           <div className="col-md-4 col-sm-6">
                              <h5 className=" heading">Contact Number</h5>
                              <span className="text-secondary ">
                                 {user?.number}
                              </span>
                           </div>
                           ...
                           <div className="col-md-4 col-sm-6 mt-4 mt-sm-0">
                              <h5 className=" heading">Email Verified</h5>
                ...
                <div className='d-flex align-items-center'>
                  ...
                  {user?.from_usa == 1 ? <i class="fa fa-check" aria-hidden="true"></i> :
                    <i class="fa fa-times" aria-hidden="true"></i>
                        ...
                        <div className="d-flex flex-column mt-4 skill-hobby">
                           ...
                           <div className="d-flex flex-wrap">
                              {user?.hobby?.split(",")?.map((item, index) => (
                                 <span>{item}</span>
                              ))}
                           </div>
                        </div>
                  ...
                  {user?.role == 4 && (
                     <div className="d-flex flex-column mt-4 skill-hobby">
                        ...
                        <p className="text-secondary mb-1">
                           ...
                           {user?.travelby == 1
                              ? "Travelling by my self"
                              : "If traveling with children under 18 or Traveling with others: You must fill out a form for each"}
                        </p>
                        <p className="text-secondary mb-1">
                           {" "}
                           <strong>Sponsor Preference</strong> :{" "}
                           {user?.sponsorcategory == 1
                              ? "Passive Sponsor: 0 Financial Commitment. Your family in the United States does not have enough income to sponsor you. If you are approved, your family or friend will take full responsibility for you. The sponsor has no financial commitment or obligation for myself"
                  ...
                  {user?.role == 4 && user?.passport && (
                     <div className="d-flex flex-column mt-4 skill-hobby">
                        <h5 className=" heading">Passport Photo</h5>
                        <a
                           target="_blank"
                           href={`${node_url}${user?.passport}`}
                        >
                           <img
                              className="img-size rounded"
                              src={`${node_url}${user?.passport}`}
                              alt="Sample photo"
                           />
                        </a>
                     </div>
